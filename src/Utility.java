...
import java.text.DecimalFormat;
    ...
    public class Utility {
         ...
         */
        public static void randomFill(int[] list, int range) {
        ...
        /**
         * заполняет list элементами value
         * @param list
         * @param value
         */
        ...
        /**
         * заполняет list элементами value типа double
         * @param list
         * @param value
         */
        public static void fillDouble(double[] list, double value) {
            for (int i = 0; i < list.length; i++) {
                list[i] = value;
            }
        }
